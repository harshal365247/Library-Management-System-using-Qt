...
QT_MOC_LITERAL(1, 7, 16), // "setCurrentWidget"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 23), // "on_submitButton_clicked"
QT_MOC_LITERAL(4, 49, 21) // "on_backButton_clicked"

    },
    "signup\0setCurrentWidget\0\0"
    "on_submitButton_clicked\0on_backButton_clicked"
};
...
void signup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&signup::setCurrentWidget)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void signup::setCurrentWidget(int _t1)
{
